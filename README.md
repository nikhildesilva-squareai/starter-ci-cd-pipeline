...
![Beginner](https://img.shields.io/badge/difficulty-beginner-22C55E) ![DevOps Engineering](https://img.shields.io/badge/course-DevOps%20Engineering-0056CE) ![8 hours](https://img.shields.io/badge/estimated-8h-lightgrey)

> **Square 1 AI** starter template — DevOps Engineering

## Overview

In this introductory project, you'll build a **CI/CD Pipeline** using GitHub Actions, Docker, Node.js. Build a complete CI/CD pipeline with automated testing and deployment. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-ci-cd-pipeline.git
cd starter-ci-cd-pipeline
